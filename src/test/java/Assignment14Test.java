...
/**
 * Verifies that the solution for homework assignment 14 works as expected.
 *
 * @author Ullrich Hafner
 */
public class Assignment14Test extends AbstractTimeoutKaraTest {
    /**
     ...
     */
    @Test
    public void shouldEatAllWithTreeCascade() {
        verifyWorld(
                new String[]{
                        "....",
                        "#...",
