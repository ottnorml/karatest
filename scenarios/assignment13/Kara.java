 ...
 * Programs should only be written in subclasses (e.g. Assignment13).
 * <p>
 * 
 ...
 * Assignment13 geschrieben werden.</i>
 * 
...
public class Kara extends Actor {
	...
	protected void showWarning(String englishMessage, String germanMessage) {
		showDialog("<html>" + englishMessage + "<p><i>" + germanMessage
				+ "</i></html>", "Warning");
	}

	private void showDialog(final String message, final String title) {
		Object[] options = { "OK", "Exit Program" };
		int choice = KaraWorld.DialogUtils.showOptionDialogEdt(null, message, title,
